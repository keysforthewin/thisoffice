 ...
 * rather than moving where it ends. How far down each *column* has to reach
 * before it can be repeated is measured from the artwork itself — see
 * vistaGeometry.ts and `npm run vista`.
 */
